    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                ...
                <li> <a href="{{route('Fees_Invoices.index')}}">{{trans('fees_trans.Receipts')}}</a> </li>
                <li> <a href="{{route('receipt_students.index')}}">{{trans('Receipt_Students.Receipt_Student')}}</a> </li>
                <li> <a href="{{route('ProcessingFee.index')}}">{{trans('ProcessingFee.Payment_Fees')}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('library.index')}}">{{trans('main_trans.show_library')}}</a> </li>
            </ul>
        </li>
