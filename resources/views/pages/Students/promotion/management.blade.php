                                ...
                                <div class="table-responsive">
                                    <table  id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th class="alert-danger">{{trans('Students_trans.Grade')}}</th>
                                            <th class="alert-danger">{{trans('Students_trans.academic_year')}}</th>
                                            <th class="alert-danger">{{trans('Students_trans.classrooms')}}</th>
                                            <th class="alert-danger">{{trans('Students_trans.section')}}</th>
