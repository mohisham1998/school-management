...
@section('content')
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <form
                                                                                        ...
                                                                                        <div class="col" style="margin-top: 10px;">
                                                                                            <label style="padding: 10px" for="inputName" class="control-label">{{ trans('Sections_trans.Name_Teacher') }}</label>
                                                                                            <button type="button" id="editButton{{$loop->iteration}}" onclick="buttonClickedFunction({{$loop->iteration}})" class="btn btn-info">{{ trans('Sections_trans.Edit') }}</button>
                                                                                            <select multiple name="teacher_id[]" class="form-control" id="selectedTeachers{{$loop->iteration}}">
                                                                                                @foreach($list_Sections->teachers as $teacher)
                                                                                                    <option selected value="{{$teacher['id']}}">{{$teacher['Name']}}</option>
                                                                                                @endforeach
                                                                                            </select>
                                                                                            <select multiple name="teacher_id[]" class="form-control" id="allTeachers{{$loop->iteration}}" hidden>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="{{ route('Sections.store') }}" method="POST">
                                        ...
                                        <div class="col">
                                            ...
                                            <select multiple name="teacher_id[]" class="form-control" id="teachers">
                                                @foreach($teachers as $teacher)
                                                    <option value="{{$teacher->id}}">{{$teacher->Name}}</option>
                                                @endforeach
                                            </select>
    ...
    <script>
        function buttonClickedFunction(iteration) {
            $("#allTeachers"+iteration).attr("hidden",false);
            $('#selectedTeachers'+iteration).hide();
        }
    </script>
